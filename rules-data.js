  ...
  rulesSections: [
    ...
    },
    {
      ...
      points: [
        ...
        "If a fixture has no odds data on file at all (nothing from the market yet, or a fetch failure), scoring falls back to a flat +5 for a correct win, +6 for a correct draw. This fallback is itself shown with a ~ before the 24-hour freeze, same as any other estimate.",
